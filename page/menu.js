						...
						'<div class="navbar-fixed">',
							'<nav class="nav-extends light-blue darken-3">',
											...
											'<div class="row">',
												'<div class="col s7">',
													...
													'<div class="right hide-on-med-and-down">',
														'<ul>',
															'<li><router-link class="active" :to="{name:\'pdf\'}">PDF</router-link></li>',
															'<li><router-link class="active" :to="{name:\'html\'}">Html</router-link></li>',
								...
								'<div class="nav-content container">',
									'<ul>',
										'<li class="btn"><router-link class="active" :to="{name:\'pdf\'}">PDF</router-link></li>',
										'<li class="btn"><router-link class="active" :to="{name:\'html\'}">Html</router-link></li>',
